...
namespace CalculateNetWorthApi.Controllers
{
    ...
    public class NetWorthController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult GetNetWorth([FromBody] PortFolioDetails portFolioDetails)
        {
        ...
        [HttpPost]
        public IActionResult SellAssets([FromBody] List<PortFolioDetails> listOfAssetsCurrentlyHoldingAndAssetsToSell)
        {
            try
            {
