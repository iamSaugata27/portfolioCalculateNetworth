        ...
        public static List<PortFolioDetails> _portFolioDetails = new List<PortFolioDetails>()
            {
                new PortFolioDetails{
                    ...
                    MutualFundList = new List<MutualFundDetails>()
                    {
                        ...
                        new MutualFundDetails{MutualFundName = "AXIS", MutualFundUnits=66}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 19, StockName = "ONGC"},
                        new StockDetails{StockCount = 667, StockName = "POWERGRID"}
                    }
                },
                new PortFolioDetails
                {
                    ...
                    MutualFundList = new List<MutualFundDetails>()
                    {
                        ...
                        new MutualFundDetails{MutualFundName = "AXIS", MutualFundUnits=566}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 240, StockName = "ONGC"},
                        new StockDetails{StockCount = 46, StockName = "POWERGRID"}
                    }
                },
                new PortFolioDetails
                {
                    ...
                    MutualFundList = new List<MutualFundDetails>()
                    {
                        ...
                        new MutualFundDetails{MutualFundName = "AXIS", MutualFundUnits=6}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 20, StockName = "ONGC"},
                        new StockDetails{StockCount = 34, StockName = "POWERGRID"},
                        new StockDetails{StockCount = 12, StockName = "TATA MOTORS"}
                    }
                }
        ...
        public async Task<NetWorth> calculateNetWorthAsync(PortFolioDetails portFolioDetails)
        {
            ...
            try
            {
                using (var httpClient = new HttpClient())
                {
                    ...
                    if (portFolioDetails.StockList != null && portFolioDetails.StockList.Count()>0)
                    {
                        foreach (StockDetails stockDetails in portFolioDetails.StockList)
                        {
                            _log4net.Info("******stockdetails are-->"+stockDetails.StockName);
                    ...
                    if (portFolioDetails.MutualFundList != null && portFolioDetails.MutualFundList.Count() > 0)
                    {
                        foreach (MutualFundDetails mutualFundDetails in portFolioDetails.MutualFundList)
                        {
                            _log4net.Info("******mutualfundsdetails are-->" + mutualFundDetails.MutualFundName);
                            _log4net.Info("******mutualfundsdetailsapi is-->" + fetchMutualFund + mutualFundDetails.MutualFundName);
